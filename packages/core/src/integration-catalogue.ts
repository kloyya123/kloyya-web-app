 ...
 *
 * Seven tools, not fifty. Kloyya Core Integrations (Private Beta) picks the set
 * that carries the most context per connection — email, calendar, the messaging
 * app many businesses actually run on, and the two places their documents live.
...
export const INTEGRATION_CATALOG: IntegrationDefinition[] = [
  ...
  // WhatsApp Business — the differentiator for businesses that run on messaging.
  define(
    'whatsapp_business',
    'WhatsApp Business',
    'communication',
    'Follows customer conversations, leads, and the follow-ups they are waiting on.',
    10,
  ),
