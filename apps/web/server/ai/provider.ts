...
// ✅ CORRECTION : Ajout de `| undefined` aux propriétés optionnelles.
// Cela satisfait `exactOptionalPropertyTypes: true` car le type de la propriété
// correspond exactement au type `string | undefined` des variables d'environnement.
export function resolveAiProvider(config: {
  ...
  // On vérifie que les deux valeurs sont bien présentes et non vides
